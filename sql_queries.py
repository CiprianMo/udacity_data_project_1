...
(songplay_id serial PRIMARY KEY, start_time bigint, user_id text, level text, song_id text, artist_id text, session_id int, location text, user_agent text)
""")
...
(song_id text PRIMARY KEY, title text, artist_id text, year int, duration decimal)
""")

artist_table_create = ("""
CREATE TABLE IF NOT EXISTS artists
(artist_id text PRIMARY KEY, name text, location text, latitude decimal, logitude decimal)
""")
